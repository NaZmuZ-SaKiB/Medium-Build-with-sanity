    ...
    <main>
      ...
      {submitted ? (
        ...
        >
          ...
          <input
            className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white text-bold px-4  py-2 rounded cursor-pointer"
            type="submit"
          />
        </form>
      )}
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // after 60 sec it will update the cached version
  };
};
